...
type Guest = 'Susie' | 'Tommy' | 'Angelica' | 'Chuckie' | 'Kimi' | 'Timmy';
let adjacentLeft: Guest;
let adjacentRight: Guest;
let furtherLeft: Guest | undefined;
let furtherRight: Guest | undefined;
